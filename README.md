# TEST IT OpenAPI Specification
[![Build Status](https://travis-ci.org/samsaggace/test-gen-openapi.svg?branch=master)](https://travis-ci.org/samsaggace/test-gen-openapi)
...
6. If you did everything correct, https://samsaggace.github.io/test-gen-openapi/ will lead to your new docs
...
- Documentation(ReDoc): https://samsaggace.github.io/test-gen-openapi/
- Look full spec:
    + JSON https://samsaggace.github.io/test-gen-openapi/swagger.json
    + YAML https://samsaggace.github.io/test-gen-openapi/swagger.yaml
- Preview spec version for branch `[branch]`: https://samsaggace.github.io/test-gen-openapi/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://samsaggace.github.io/test-gen-openapi/ with url from the message: `Server started <url>`
